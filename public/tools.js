...
function openTools() {
    optionsCont.children[0].style.display = "none";
    optionsCont.children[1].style.display = "block";

    toolsCont.style.display = "flex";
}
function closeTools() {
    optionsCont.children[1].style.display = "none";
    optionsCont.children[0].style.display = "block";
